...
const mockWorks: Work[] = [
  {
    ...
    role: "Supporting",
    poster: null,
    synopsis: "A drama about three brothers going through hardships in life and a cold young woman who has to endure her own.",
    trailerUrl: null,
    type: "drama",
  },
  {
    ...
    role: "Lead",
    poster: null,
    synopsis: "A politician's wife with a secret past becomes involved in a moral dilemma that shakes the foundations of her family.",
    trailerUrl: null,
    type: "drama",
  },
  {
    ...
    role: "Lead",
    poster: null,
    synopsis: "A love story set between Earth and a space station.",
    trailerUrl: null,
    type: "drama",
  },
];
